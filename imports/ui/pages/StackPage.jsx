...
const StackPage = ({ classes }) => (
  <Grid container direction="column" alignItems="center">
    <Typography paragraph variant="display1">
      NOINCOMEDEV is built with...
    </Typography>
    <GridList cellHeight={180} className={classes.gridList} cols={8}>
      <GridListTile cols={2} component={Link} to="https://www.namecheap.com/">
        <img
      ...
      <GridListTile cols={3} component={Link} to="https://www.ubuntu.com/">
        <img
      ...
      <GridListTile cols={2} component={Link} to="https://www.nginx.com/">
        <img
      ...
      <GridListTile cols={2} component={Link} to="https://www.cloudflare.com/">
        <img
          src="https://www.cloudflare.com/img/cf-facebook-card.png"
          alt="Cloudflare"
        />
      </GridListTile>
      <GridListTile cols={2} component={Link} to="https://github.com/">
        <img
          src="https://avatars0.githubusercontent.com/u/9919?s=280&v=4"
          alt="Github"
        />
      </GridListTile>
      <GridListTile cols={2} component={Link} to="https://www.docker.com/">
        <img
          src="https://i1.wp.com/blog.docker.com/wp-content/uploads/2013/06/Docker-logo-011.png?ssl=1"
          alt="Docker"
        />
      </GridListTile>
      <GridListTile cols={4} component={Link} to="https://www.meteor.com/">
        <img
          src="https://d14jjfgstdxsoz.cloudfront.net/assets/og-image-logo.png"
          alt="MeteorJS"
        />
      </GridListTile>
      <GridListTile cols={2} component={Link} to="https://www.mongodb.com/">
        <img
          src="https://redash.io/assets/images/integrations/mongodb.png"
          alt="MongoDB"
        />
      </GridListTile>
      <GridListTile cols={2} component={Link} to="https://www.mlab.com/">
        <img
      ...
      <GridListTile cols={4} component={Link} to="https://reactjs.org/">
        <img
          src="https://www.valuecoders.com/blog/wp-content/uploads/2016/08/react.png"
          alt="ReactJS"
        />
      </GridListTile>
      <GridListTile cols={2} component={Link} to="https://material-ui.com/">
